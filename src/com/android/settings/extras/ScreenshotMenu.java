...
public class ScreenshotMenu extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String ARMV6_SCREENSHOT_SOUND = "armv6_screenshot_sound";

    private static final String ARMV6_SCREENSHOT_DELAY = "armv6_screenshot_delay";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mScreenshotSound = (CheckBoxPreference) prefSet.findPreference(ARMV6_SCREENSHOT_SOUND);
        mScreenshotDelay = (ListPreference) prefSet.findPreference(ARMV6_SCREENSHOT_DELAY);
